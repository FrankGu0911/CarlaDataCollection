...
bash data_collection/bashs/weather-9/routes_town03_tiny.sh & 
bash data_collection/bashs/weather-10/routes_town03_tiny.sh & 
bash data_collection/bashs/weather-11/routes_town03_tiny.sh & 
bash data_collection/bashs/weather-12/routes_town03_tiny.sh & 
bash data_collection/bashs/weather-13/routes_town03_tiny.sh & 
